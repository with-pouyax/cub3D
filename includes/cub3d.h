...
void	init_parse_data(t_parse_data *data, t_dir_flags *dir_flags, t_color_flags *color_flags, int *found_map_start);
int		process_current_line(t_file *map, int *index, t_parse_data *data);
int		parse_textures_and_colors(t_file *map, int *index, t_dir_flags *dir_flags, t_color_flags *color_flags);
